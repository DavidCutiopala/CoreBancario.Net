...
namespace EcVotoElectronico.Repositorios
{
    public class ProcesoElectoralRepository : EntityFrameworkReadOnlyRepository<VotoDbContext>, IProcesoElectoralRepository
    {
        ...
        public IEnumerable<Pe01_ProcesoElectoral> FiltrarProcesoElectoralPorNombre(ISpecification<Pe01_ProcesoElectoral> specification)
          => Context.Pe01_ProcesoElectoral.Where(specification.SatisfiedBy());
